...
// Default experiences value if not updated
// Use experiences from session if available; otherwise, use a default value
$experiences = isset($_SESSION['experiences']) && !empty($_SESSION['experiences']) ? $_SESSION['experiences'] : "programming <br> UX";
?>
    ...
    <div class="container">
        ...
        <section class="profile-card">
            <div class="profile-content">
                ...
                <div class="input-group">
                    ...
                    <p id="experiences-display" class="input-field"><?php echo $experiences; ?></p>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <form id="editProfileForm">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Email is not allowed to be changed; set it to read-only -->
                        <input type="email" id="email" value="<?php echo htmlspecialchars($email); ?>" class="form-input" readonly>
                    </div>
                    <div class="form-group">
                        <label for="experiences">Experiences:</label>
                        <textarea id="experiences" class="form-input"><?php echo (isset($_SESSION['experiences']) ? htmlspecialchars($_SESSION['experiences']) : "programming\nUX"); ?></textarea>
                    </div>
        ...
        <section class="profile-card">
            ...
            <div id="team-members" class="team-members-container">
                <?php
                // Query to display teams where the user is the leader
                ...
                if ($teamsResult->num_rows > 0) {
                    while ($team = $teamsResult->fetch_assoc()) {
                        ...
                        echo '<div class="team-member-list">';
                        while ($member = $membersResult->fetch_assoc()) {
                            echo '<div class="team-member-card">';
                            echo '<div class="team-member-avatar"></div>';
                            echo '<div class="team-member-info">';
